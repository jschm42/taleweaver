...
export const api = {
  ...
  generateTTS(payload: { text: string; scene_description?: string; adventure_id?: string; title?: string; scene_name?: string; tone?: string; voice_override?: string; speaker_voices?: Record<string, string> }): Promise<{ audio_url: string }> {
