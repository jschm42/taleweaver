           ...
           <div class="bg-slate-900/60 border border-white/5 rounded-3xl p-6 flex gap-6 backdrop-blur-md shadow-xl">
             ...
             <div class="shrink-0 relative group">
               ...
               <div class="absolute top-1.5 right-1.5 z-40">
                 <button @click="emit('toggle-menu', debugData.protagonist.id, $event)" class="w-7 h-7 rounded-full bg-black/70 backdrop-blur-md border border-white/10 flex items-center justify-center text-white hover:bg-emerald-500 transition-all shadow-lg">
