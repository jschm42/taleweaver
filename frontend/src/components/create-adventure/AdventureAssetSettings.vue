  ...
  <div class="space-y-5 md:space-y-6">
    ...
    <div class="flex items-center justify-between gap-2">
      ...
      <div
        ...
        :class="['w-10 h-5 rounded-full relative cursor-pointer transition-colors shrink-0', automatedAssetsEnabled ? 'bg-aether-primary' : 'bg-slate-700']"
      >
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
      <button
        ...
        class="p-3.5 sm:p-4 rounded-2xl border-2 transition-all flex items-center gap-3 disabled:opacity-40 disabled:cursor-not-allowed text-left"
      ...
      >
        <component :is="asset.icon" class="w-4 h-4 shrink-0" />
