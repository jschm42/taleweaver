...
// Character selection removed — protagonist will be generated by the world-builder
...
// Character management removed from new-adventure flow
      ...
      <div class="bg-slate-900 border border-slate-700 rounded-3xl w-full max-w-2xl max-h-[90vh] overflow-y-auto relative z-10 shadow-2xl p-8 flex flex-col animate-fade-in-up">
        ...
        <div class="space-y-5">
          ...
          <div>
           ...
           <!-- Character selection removed — protagonist is auto-generated by the world-builder -->
