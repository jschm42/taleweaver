...
async def _persist_npcs(
    ...
    for idx, n in enumerate(npcs, start=1):
        ...
        db.add(WorldEntity(
            ...
            movement_type="MOVABLE" if (n.get("moveable") is True or str(n.get("movement_type") or "").upper() == "MOVABLE") else "STATIONARY",
            moveable=bool(n.get("moveable")) if n.get("moveable") is not None else (str(n.get("movement_type") or "").upper() == "MOVABLE"),
            allowed_scenes=n.get("allowed_scenes") or [],
