        ...
        try:
            ...
            with zipfile.ZipFile(zip_buffer, "r") as zip_file:
                ...
                new_template = AdventureTemplate(
                    ...
                    max_memory_turns=adv_data.get("max_memory_turns") or manifest_data.get("max_memory_turns") or 30,
        ...
        try:
            ...
            if is_session and allow_session:
                ...
                new_template = AdventureTemplate(
                    ...
                    max_memory_turns=old_adv.get("max_memory_turns") or 30,
                ...
                new_template = AdventureTemplate(
                    ...
                    max_memory_turns=adv_meta.get("max_memory_turns") or manifest.get("max_memory_turns") or 30,
