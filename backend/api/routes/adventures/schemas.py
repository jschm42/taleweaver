...
class AdventureTemplateResponse(BaseModel):
    ...
    @classmethod
    def normalize_tone(cls, v: Any) -> Optional[Dict[str, Any]]:
    ...
    @classmethod
    def normalize_styles(cls, v: Any) -> Optional[List[Dict[str, Any]]]:
        if isinstance(v, list):
            return [{"id": s} if isinstance(s, str) else s for s in v]
        return v
