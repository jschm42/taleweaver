...
GM_CHAT_TOOL_INTENT_SUFFIX = (
    ...
    "To create a new result from a combination that is added to the scene, use `spawned_items`. If the result goes directly to the player, use `new_inventory_items`. NOTE: CONSTRUCTABLE items are resolved deterministically by the engine (ingredients auto-consumed, result auto-revealed) — do not manually spawn or consume CONSTRUCTABLE ingredients; just narrate the construction. "
