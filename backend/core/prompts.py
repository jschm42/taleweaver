...
GM_CHAT_MINIMAL_RULE_PASS_PROMPT = (
    ...
    "Return only these intent fields when justified: `new_inventory_items`, `removed_inventory_item_ids`, `updated_inventory_items`, `spawned_items`, `hp_change`, `stamina_change`, `mana_change`, `completed_quest_ids`, `earned_award_keys`, `remember_notes`, `forget_notes`, `clear_notes`, `game_completed`, `game_over`, `status_note`, `moved_entities`, `updated_entities`.\n\n"
    "OPEN QUESTS (REDUCED):\n"
    "{quests_json}\n"
