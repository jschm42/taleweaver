...
GAME_MASTER_SYSTEM_PROMPT_TEMPLATE = (
    ...
    "NPCs in other scenes must NOT deliver direct dialogue here unless they first move into the current scene via `moved_entities`, "
    "or are clearly represented as distant/indirect audio (not direct interaction).\n\n"
