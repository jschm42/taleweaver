...
WORLD_GENERATION_SYSTEM_PROMPT = (
    ...
    "- For WEARABLE/WEAPON items, assign a preferred slot in `wearable_slots`. Valid slots: Head, Chest, Arms, Legs, Hands, Feet, Ring_1, Ring_2, Amulet, Main_Hand, Off_Hand.\n"
    ...
    "Optionally assign 'hp', 'mana', 'stamina', and 'stat_modifier_armor_class' (bonus to base AC 10) if they are relevant for combat. "
...
GM_MECHANICS_SUFFIX = (
    ...
    "INVENTORY & EXCHANGES:\n"
    "- To add an item to the player, use `new_inventory_items`.\n"
