...
class SVGPlaceholderGenerator:
    ...
    def _generate_ra_pawn(self, color: str = "#555555") -> str:
        """Generiert das ra-pawn Icon (Game-icons.net Pawn) als SVG."""
        ...
        return f'<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512"><path fill="{color}" d="{path_data}"/></svg>'
